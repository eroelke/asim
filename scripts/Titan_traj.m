...
function [nom,nom2,nom3,terminate,mach_ind,vel_ind2,ind3,vel,alt, ... 
    time,dr,cr,heat_rate,q,decel,lat,lon,mass,drag,az,gamma] = Titan_traj(in,mach_pc,v_pf,d_pf,d_pc,run_disp)
%#codegen
