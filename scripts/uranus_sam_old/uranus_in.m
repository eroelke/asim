% uranus_in.m 
%   like earth_in, but for Uranus
%   basic input structure for Uranus entry
...
%
% Created June 2019, S. Albert
% 
function in = uranus_in()
%#codegen
...
%% Planetary data
in.p = get_planetary_data( 7, 2 ); % Load settings for Uranus, no winds
% temp = load('data\atm_uranus_ames_3sigLow.mat'); % 2
temp = load('data\atm_uranus_ames.mat'); % 1
% temp = load('data\atm_uranus_ames_3sigHigh.mat'); % 3
in.p.atm.table = temp.table;

%% Constants
in.c.earth_g = 9.80665;
