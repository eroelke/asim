%% cv_dma_titan
%   -Titan drag modulation aerocapture trajectory.
...
function out = cv_dma_titan(efpa, ha_tgt, ha_tol, v_atm, ... 
...
in0 = cv_dma_titan_in; % nominal input structure

%% Get atmospheric profile
temp = load('.\data\atm_titan_gram_10000mc_reg_winds.mat');
mc_atm = temp.atm_mc_reg_tables.mc;
in0.p.atm.table = temp.atm_mc_reg_tables.nom_table;
...
in0.v.gnc.g.p_cvdma.t_max = 5000;

% density corrector
in0.v.gnc.g.p.K_gain = 0.1;
...
in0.v.gnc.g.p_cvdma.A_sens_atm = 0.1;
