% dme_mars_in.m 
%   Create input structure for drag-modulated entry at Earth.
%
...
in.p = get_planetary_data( 2, 3 ); % Load settings for Earth, exponential atmosphere
