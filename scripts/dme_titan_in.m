% dme_venus_in.m 
%   Create input structure for drag-modulated entry at Titan.
%
...
%   *Created JAN 2017, M.S.Werner

function in = dme_titan_in()
%#codegen
...
in.p = get_planetary_data( 6, 2 ); % Load settings for Venus, table atmosphere
...
% Aerodynamics
in.v.aero.mode = uint8(2); % uint8, nd, aerodynamics mode (table lookup)
