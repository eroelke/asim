...
in.p = get_planetary_data( 6, 3 ); % Load settings for Mars, table atm model
...
in.v.gnc.g.p_manual.area_refs(1:2) = [in.v.aero.area_ref; in.v.mp.m_ini/(in.v.aero.cd*beta2)]; % m^2
in.v.gnc.g.p_manual.masses(1:2) = [in.v.mp.m_ini in.v.mp.m_ini]; % kg
