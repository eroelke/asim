...
% 
function [ydot,alt] = ... 
    eom_npc_ensemble(t, y, Aref, p, s, cd, cl, mass, atm_curr)
%#codegen
...
drag_pp = q*cd*Aref*drag_pp_hat; % Planet relative drag force vector
lift_pp_hat = R2*R1*vel_pp_rw_hat; % Planet relative lift force direction
lift_pp = q*cl*Aref*lift_pp_hat; % Planet relative lift force vector
